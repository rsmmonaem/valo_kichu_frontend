    ...
    <div className="min-h-screen bg-gray-50/50 pb-20">
      ...
      <div className="container mx-auto px-4 -mt-6 md:-mt-10 relative z-20">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-5 sm:p-8 md:p-12 border border-gray-100">
          <div 
            className="prose prose-sm sm:prose-base md:prose-lg lg:prose-xl prose-emerald max-w-none text-gray-700 leading-relaxed marker:text-emerald-500 prose-headings:text-gray-900 prose-a:text-emerald-600 hover:prose-a:text-emerald-500 overflow-x-auto w-full"
