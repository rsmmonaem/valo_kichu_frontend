    ...
    useEffect(() => {
        ...
        authFetch(`/admin/v1/blogs/${id}`)
            ...
            .then(blog => {
                ...
                if (blog.slug) setExistingSlug(blog.slug);
                setLoading(false);
            })
            .catch(() => {
            ...
            <div className="bg-white border-b border-slate-200/80 sticky top-0 z-30 shadow-xs backdrop-blur-md bg-white/90">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        {existingSlug && (
                            <Link 
                                href={`/blogs/${existingSlug}`} 
                                target="_blank"
                                className="px-3 py-2 text-xs font-semibold text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-xl transition flex items-center gap-1.5"
                            >
            ...
            <form onSubmit={handleSubmit} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        {/* Save Box (Secondary Quick Action) */}
                        <div className="bg-gradient-to-br from-blue-900 to-indigo-950 text-white rounded-2xl p-6 shadow-md space-y-4">
                            <div>
                                <h4 className="font-bold text-base flex items-center gap-2">
                                    <CheckCircle2 size={18} className="text-emerald-400" /> Save changes
                                </h4>
                                <p className="text-xs text-blue-200/80 mt-1">
                                    Updates will be reflected across your website immediately.
                                </p>
                            </div>
                            <button
                                type="submit"
                            ...
                            >
                                <Save size={16} />
                                <span>{saving ? 'Saving Changes...' : 'Save Blog Post'}</span>
                            </button>
                        </div>
