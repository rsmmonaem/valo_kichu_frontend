        ...
        <>
            ...
            <div className={clsx(
                ...
                <div className="p-4 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <button onClick={onClose} className="p-2 hover:bg-gray-100 active:bg-gray-200 rounded-full text-gray-400 hover:text-gray-700 transition-colors">
                        <X size={20} />
                    </button>
                </div>
                ...
                <div className="p-4 border-b border-gray-50 bg-gray-50/50">
                    <form onSubmit={(e) => {
                        ...
                        <div className="relative">
                            ...
                            />
                            <button type="submit" className="absolute right-3 top-2.5 text-gray-400 hover:text-blue-600 p-0.5 transition-colors">
                                <Search size={16} />
                            </button>
                        </div>
                    </form>
